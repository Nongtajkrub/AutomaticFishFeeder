...
class NTPClient {
  ...
  public:
    ...
    NTPClient(WiFiUDP& udp, IPAddress poolServerIP);
    NTPClient(WiFiUDP& udp, IPAddress poolServerIP, long timeOffset);
    NTPClient(WiFiUDP& udp, IPAddress poolServerIP, long timeOffset, unsigned long updateInterval);
    ...
    /**
     * Starts the underlying WiFiUDP client with the default local port
     */
    void begin();

    /**
     * Starts the underlying WiFiUDP client with the specified local port
     */
    ...
    /**
     * Stops the underlying WiFiUDP client
     */
    void end();
};
